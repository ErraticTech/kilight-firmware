...
// This header may be included by other board headers as "boards/kilight-mono-v1.0.x.h"
...
// KiLight Mono HW Revision
#ifndef HARDWARE_REVISION_MAJOR
#define HARDWARE_REVISION_MAJOR 1
#endif
#ifndef HARDWARE_REVISION_MINOR
#define HARDWARE_REVISION_MINOR 0
#endif

// Pause the WDT when debugging. Causes issues sometimes so only turn it on when you're actually debugging
#ifndef KILIGHT_PAUSE_WDT_ON_DEBUG
